...
def wea_answers(questions, output_filename, wea_logs_file):
    ...
    answers = pandas.read_csv(wea_logs_file, encoding="utf-8").drop_duplicates(QUESTION)
    answers = answers[answers[QUESTION].isin(questions)]
...
if __name__ == "__main__":
    ...
    wea_parser.add_argument("wea_logs_file", metavar="wea", type=argparse.FileType(),
                            help="WEA logs generated by process_wea_logs.py")
