...
from themis.nlc import train_nlc, NLC, classifier_list, classifier_status, remove_classifiers,train_nlc_router
...
def nlc_router_train_handler(args):
    print(train_nlc_router(args.url, args.username, args.password, args.collated, args.oracle_result, args.name))
...
def analyze_command(parser, subparsers):
    ...
    nlc_router_train = subparsers.add_parser("nlc-router-train", formatter_class=Raw, description=textwrap.dedent("""
    ...
    nlc_router_train.add_argument("url", help = "NLC url")
    nlc_router_train.add_argument("username", help="NLC username")
    nlc_router_train.add_argument("password", help="NLC password")
    nlc_router_train.add_argument("collated", type=CollatedFileType(), help="collated file created for oracle")
    nlc_router_train.add_argument("oracle_result", type=CollatedFileType(), help="output file created by oracle")
    nlc_router_train.add_argument("name", help="classifier name")
