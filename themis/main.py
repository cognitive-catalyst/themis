...
def analyze_command(parser, subparsers):
    ...
    nlc_common_arguments = argparse.ArgumentParser(add_help=False)
    nlc_common_arguments.add_argument("url", help="NLC url")
    nlc_common_arguments.add_argument("username", help="NLC username")
    nlc_common_arguments.add_argument("password", help="NLC password")
    ...
    nlc_router_subparsers = nlc_router.add_subparsers(title="NLC as a router",
                                               description="train, test, and manage NLC as a router model", help="NLC as a router actions")
