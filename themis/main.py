...
from themis.analyze import SYSTEM, CollatedFileType
...
def plot_command(subparsers):
    ...
    plot_parser.set_defaults(func=curves_handler)
...
def analyze_command(parser, subparsers):
    ...
    collate.add_argument("frequency", type=QuestionFrequencyFileType(),
                         help="question generated by the 'question extract' or 'question sample' commands")
...
def collate_handler(parser, args):
    ...
    for label, answers in labeled_qa_pairs:
        collated = add_judgments_and_frequencies_to_qa_pairs(answers, judgments, args.frequency)
